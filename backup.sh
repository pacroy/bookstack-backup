...
kubectl exec --context "$KUBE_CONTEXT" --namespace="$WIKI_NAMSPACE" --container="bookstack" "$BOOKSTACK_POD_NAME" -- tar czf - /var/www/bookstack/public/uploads/* > ./backup/uploads.tgz
